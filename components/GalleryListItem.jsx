...
const GalleryListItem = forwardRef(({ data, isActive, setActive }, ref) => {
  ...
  return (
    ...
    >
      ...
      >
        {isActive ? (
          <div className="flex h-full w-full">
            ...
            <aside className="w-1/4 p-6 lg:p-8 flex flex-col justify-between text-neutral-800 bg-white font-light border-r border-neutral-200">
              <div>
                <h3 className="text-sm md:text-base lg:text-2xl font-light tracking-tight mb-3">
                  {sample.title}
                </h3>
                ...
                <div className="mt-12 text-[11px] tracking-wider space-y-2">
                  {sample.client && (
                    <p>
          ...
          <div className="flex h-full w-full justify-between items-stretch overflow-x-hidden">
            ...
            >
              <div className="ml-auto flex flex-col items-end">
                ...
                <h3 className="text-xs md:text-sm font-light tracking-tight text-right">
                  {sample.title}
                </h3>
                <p className="text-[10px] md:text-xs text-neutral-500 mt-1 text-right">
                  {sample.location}
                </p>
              </div>
            </div>
        ...
        {/* Close control moved outside component for global placement */}
      </div>
