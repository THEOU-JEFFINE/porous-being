...
/**
 * Images are now loaded directly from componentData
 * Passed as a prop to avoid import.meta.glob on client side
 */
 ...
 */
export default function HorizontalScrollGalleryExample({ componentData = [] }) {
  ...
  // Framer Motion variants for category buttons
  ...
  // Detect scroll direction to show/hide category bar
  React.useEffect(() => {
    const handleScroll = () => {
    ...
    const handleScroll = () => {
      ...
      scrollTimeout = setTimeout(() => {
        ...
        Object.entries(projectRefs.current).forEach(([, ref]) => {
          ...
          ref.style.transition = "all 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)";
  ...
  return (
    <div ref={containerRef} className="w-full min-h-screen bg-white">
      ...
      <motion.div
        className="sticky bg-white z-40 px-3 sm:px-6 lg:px-12 py-0.5 pt-3"
        style={{ top: "48px" }}
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center gap-2 sm:gap-4 lg:gap-6 py-0.5 overflow-x-auto scrollbar-hide px-2">
            {isMobileNav ? (
      ...
      {/* Projects Grid */}
      <div className="flex flex-col items-center pt-4 pb-16 px-3 sm:px-6 lg:px-12">
