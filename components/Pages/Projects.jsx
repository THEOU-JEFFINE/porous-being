...
const HorizontalScrollGalleryExample = lazy(
  () => import("../HorizontalScrollGalleryExample"),
);
 ...
 * @property {string} typology - Project typology/category
 * @property {string[]} images - Array of image paths
 */

/**
 * @param {{ componentData?: ComponentDataItem[] }} props
 */
export default function Projects({ componentData = [] }) {
    ...
    <>
      ...
      <main className="w-full">
        ...
        <Suspense fallback={<GalleryLoadingFallback />}>
          {isReady ? (
            <HorizontalScrollGalleryExample componentData={componentData} />
          ) : null}
        </Suspense>
      </main>
    </>
